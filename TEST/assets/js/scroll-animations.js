...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // Make hero panel visible immediately
  ...
  // Add scale animation on cast cards scroll
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (castSection) {
      ...
      // Set initial state for cast cards
      const castCards = castSection.querySelectorAll('.cast-card');
